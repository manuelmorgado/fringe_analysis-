...
%
% se requiere que las franjas seleccionadas sea lo más vertical posibles, o
...
% 
% para seleccionar la imagen, usa boton alterno del cursor y saldra un menú
% donde aparece el comando de ejecución de crop
% 
...
format short % formato de salida de numeros, que es más comodo
 ...
 % Esto convierte unos o ceros la matriz z, para contar de modo más sencillo
 % la transición 
for n = 1:length(a) 
...
% Empíeza el contador de franjas
